                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="harga-satuan[]" value="<?php echo $value->harga_satuan ?>" class="form-control-plaintext" readonly />
                                                        </td>
                                                        <td>
                                                            <input type="number" name="pengeluaran[]" value="<?php echo $value->harga_satuan * $value->volume ?>" class="form-control-plaintext" readonly />
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
