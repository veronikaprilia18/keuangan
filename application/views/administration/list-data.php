        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Data Anggaran Administrasi</h6>
                                    ...
                                    foreach ($anggaran as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javacript:void(0)" class="btn btn-success" onclick="return showModal('<?php echo $value->id_anggaran ?>', '<?php echo $value->id_klien ?>','<?php echo $value->tahun ?>')"><i class="fa fa-eye"></i></a>
...
<div class="modal fade" id="detail-modal" tabindex="-1" role="dialog" aria-labelledby="detail-modal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('dashboard/detail_data_admin') ?>" method="GET">
            ...
            <form action="<?php echo site_url('dashboard/edit_admin') ?>" method="GET" target="_blank">
                <div class="card mx-4 mb-4">
                    ...
                    <div class=" card-body modal-body">
                        <input type="hidden" name='tahun' />
                        <input type="hidden" name='id-klien' />
                        <input type="hidden" name='id-anggaran' />
                        <input type="hidden" name='select-kategori' value='1' />
                        <div class="form-group">
...
<script>
    function showModal(idAnggaran, idKlien, tahun) {
        $('[name="id-anggaran"]').val(idAnggaran);
