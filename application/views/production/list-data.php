        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Data Anggaran Production</h6>
                                    ...
                                    foreach ($anggaran as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo site_url('dashboard/detail_data_production/' . $value->id_anggaran) ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
